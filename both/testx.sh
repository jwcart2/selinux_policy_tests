...
#python3 -m site --user-base $PREFIX/usr/local/lib/python3.7/site-packages/setools
python3 -m site
...
$SETOOLS/sediff test_03.conf.orig.bin test_03.conf.opt.bin > test_03-conf.sediff
